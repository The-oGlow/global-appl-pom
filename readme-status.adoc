...
{proj_vcsid_url}/-/pipelines[image:{proj_vcsid_url}/badges/master/pipeline.svg[GitLab-CI]]
link:{proj_vcsid_url}/-/tags[image:{cmmn_badge_url}/release-latest-blue?logo=gitlab{cmmn_img_style}[Latest Tag]]
